# Bitácora — tramo fósil (2026-07 → 2026-08-04)

Este archivo es el CLAUDE.md ORIGINAL tal como quedó el 2026-08-04, cuando
pasó de 118k caracteres y Claude Code (que carga 40k) empezó a cortarlo.
Las reglas vigentes se destilaron al CLAUDE.md nuevo; esto se conserva
ÍNTEGRO y sin editar como historial de julio (decisiones, validaciones y
autopsias de la primera etapa). Las jornadas del 2026-08-05 en adelante
siguen en `bitacora.md`. Buscar con grep; no volver a mezclarlo.
